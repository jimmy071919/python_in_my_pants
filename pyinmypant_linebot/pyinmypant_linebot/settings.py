"""
Django settings for pyinmypant_linebot project.
...
SECRET_KEY = 'django-insecure-jnv#3mrci=aze*j(3qk6egkvz89f^w_(rbd*1)nw7_o39z74_z'
...
ROOT_URLCONF = 'pyinmypant_linebot.urls'
...
WSGI_APPLICATION = 'pyinmypant_linebot.wsgi.application'
